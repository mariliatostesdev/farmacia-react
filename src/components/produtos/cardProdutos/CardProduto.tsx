		...
		<div className="border-slate-400 border flex flex-col rounded-lg overflow-hidden justify-between w-80 sm:w-80 md:w-72 ">
			...
			<div className="flex">
				<Link
					...
					className="w-full  text-white bg-[#4a52bb] hover:bg-[#313893] flex items-center justify-center py-2 hidden"
				>
					<button>Editar</button>
				</Link>
				<Link
					to={`/deletarProduto/${product.id}`}
					className="text-white bg-[#FF4C4F] hover:bg-[#B91C1C] w-full flex items-center justify-center hidden"
				>

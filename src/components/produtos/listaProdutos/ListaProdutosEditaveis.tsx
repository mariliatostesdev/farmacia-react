...
import CardProdutoEditavel from '../cardProdutos/CardProdutoEditavel';
import Home from '../../../paginas/home/Home';
import ModalProduto from '../modalProduto/ModalProduto';

function ListaProdutosEditaveis() {
			...
			<div className="w-full flex justify-center">
				<div className="container mx-auto my-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 justify-items-center">
					{produtos.map((produto) => (
						<CardProdutoEditavel key={produto.id} product={produto} />
					))}
				</div>
			</div>
		</>
...
export default ListaProdutosEditaveis;

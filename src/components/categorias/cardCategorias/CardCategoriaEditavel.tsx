...
interface CardCategoriaEditavelProps {
	categoria: Categoria;
}

function CardCategoriaEditavel({ categoria }: CardCategoriaEditavelProps) {
	return (
		<div className="border flex flex-col rounded-2xl overflow-hidden text-center w-72 h-fit">
			<div className="">
				...
				<Link
					to={`/`}
					className="bg-white pb-10 flex content-center justify-center h-fit cursor-pointer hidden"
				>
...
export default CardCategoriaEditavel;
